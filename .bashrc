...
echo -e "o snappy and floating mode setup on i3. keyboard shorcut to launch"
echo -e "o scrcpy keyboard shortcuts"
echo -e "o what is webview on android"
echo -e "o find a wayt to decrease phone brightness to 0"
echo -e "o disable protonvpn in i3 config. it cause problems"
...
echo -e "o answer hasan from telegram"
